...
INNER JOIN qwu6617.McDonald_SU_PatientPop1 pop		--update pop
...
INNER JOIN EDWCL_VIEWS.Clinical_Patient_Proc_Result CPPR
	...
	AND CPPR.Result_Verify_Date BETWEEN '2014-01-01' AND Current_Date	--UPDATE BEGINNING DATE FOR POP
